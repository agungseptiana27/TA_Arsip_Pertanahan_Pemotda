...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Arsip Keluar </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <a href="/input-sk" type="button" class="btn btn-gradient-primary btn-icon-text btn-sm">
                    <i class="mdi mdi mdi-plus btn-icon-prepend"></i>Tambah Arsip</a>
                @endif
            </ol>
        </nav>
    </div>
    ...
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body" style="overflow-x:auto;">
                <h4 class="card-title">Arsip Keluar</h4>
                    ...
                    <table id="example1" class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th> Nomor Arsip </th>
                                <th class="col-md-1"> Tanggal Arsip </th>
                                <th> Tujuan </th>
                                <th> Perihal</th>
