...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('thema/assets/images/Provinsi-Jawa-Barat.png') }}" />
</head>
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="/surat">
                    <img src="{{ asset('thema/assets/images/logo.png') }}" alt="logo"
                        class="mx-auto d-block w-10 h-auto" />
                </a>
                <a class="navbar-brand brand-logo-mini text-center" href="surat">
                    <img src="{{ asset('thema/assets/images/Provinsi-Jawa-Barat.png') }}" alt="logo"
                        class="mx-auto d-block w-50 h-auto" />
                </a>
            </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/view-sm">Arsip Masuk</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/view-sk">Arsip
                                        Keluar</a></li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="container-fluid clearfix">
                        <!-- <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © PEMOTDA
                        </span> -->
                        &copy; {{ now()->year }} <a href="#" class="font-weight-bold ml-1">PEMOTDA</a> &amp;
                        <a href="#" class="font-weight-bold ml-1">Provinsi Jawa Barat</a>
                    </div>
                </footer>
                <!-- partial -->
            </div>
