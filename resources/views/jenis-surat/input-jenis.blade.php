...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title"> Tambah Jenis Arsip</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Jenis Arsip</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Jenis Arsip</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tambah Jenis Arsip</h4>
                <p class="card-description"></p>
                <form action="/save-jenis" method="POST" class="forms-sample" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="exampleInputEmail3">Kode Jenis Arsip</label>
