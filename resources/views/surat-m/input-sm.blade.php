...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title"> Tambah Arsip Masuk</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Arsip Masuk</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Arsip Masuk</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tambah Arsip Masuk</h4>
